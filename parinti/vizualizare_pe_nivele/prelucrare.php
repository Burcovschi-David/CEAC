...
while($a!=42){
    ...
    if($a==10 || $a==11 || $a==12 || $a==2 || $a==14 || $a==15 || $a==16 || $a==30 || $a== 38 || $a==32 || $a==41 || $a==42 ){
	    ...
	    if($a==10){
			...
			$result=mysqli_query($con,"SELECT * FROM parinte where clasa='".$_POST['clasa_de_vazut']."A' || clasa='".$_POST['clasa_de_vazut']."B' || clasa='".$_POST['clasa_de_vazut']."C'|| clasa='".$_POST['clasa_de_vazut']."D' || clasa='".$_POST['clasa_de_vazut']."E' || clasa='".$_POST['clasa_de_vazut']."F' || clasa='".$_POST['clasa_de_vazut']."G'");
		...
		$result1=mysqli_query($con,"SELECT * FROM parinte WHERE intrebare".$a."='a' && ( clasa='".$_POST['clasa_de_vazut']."A' || clasa='".$_POST['clasa_de_vazut']."B' || clasa='".$_POST['clasa_de_vazut']."C'|| clasa='".$_POST['clasa_de_vazut']."D' || clasa='".$_POST['clasa_de_vazut']."E' || clasa='".$_POST['clasa_de_vazut']."F' || clasa='".$_POST['clasa_de_vazut']."G')");
		$result2=mysqli_query($con,"SELECT * FROM parinte WHERE intrebare".$a."='b' && (  clasa='".$_POST['clasa_de_vazut']."A' || clasa='".$_POST['clasa_de_vazut']."B' || clasa='".$_POST['clasa_de_vazut']."C'|| clasa='".$_POST['clasa_de_vazut']."D' || clasa='".$_POST['clasa_de_vazut']."E' || clasa='".$_POST['clasa_de_vazut']."F' || clasa='".$_POST['clasa_de_vazut']."G')");
		$result3=mysqli_query($con,"SELECT * FROM parinte WHERE intrebare".$a."='c' && ( clasa='".$_POST['clasa_de_vazut']."A' || clasa='".$_POST['clasa_de_vazut']."B' || clasa='".$_POST['clasa_de_vazut']."C'|| clasa='".$_POST['clasa_de_vazut']."D' || clasa='".$_POST['clasa_de_vazut']."E' || clasa='".$_POST['clasa_de_vazut']."F' || clasa='".$_POST['clasa_de_vazut']."G')");
		$result4=mysqli_query($con,"SELECt * FROM parinte WHERE intrebare".$a."='d' && (  clasa='".$_POST['clasa_de_vazut']."A' || clasa='".$_POST['clasa_de_vazut']."B' || clasa='".$_POST['clasa_de_vazut']."C'|| clasa='".$_POST['clasa_de_vazut']."D' || clasa='".$_POST['clasa_de_vazut']."E' || clasa='".$_POST['clasa_de_vazut']."F' || clasa='".$_POST['clasa_de_vazut']."G')");
		$result5=mysqli_query($con,"SELECT * FROM parinte WHERE intrebare".$a."='e' && ( clasa='".$_POST['clasa_de_vazut']."A' || clasa='".$_POST['clasa_de_vazut']."B' || clasa='".$_POST['clasa_de_vazut']."C'|| clasa='".$_POST['clasa_de_vazut']."D' || clasa='".$_POST['clasa_de_vazut']."E' || clasa='".$_POST['clasa_de_vazut']."F' || clasa='".$_POST['clasa_de_vazut']."G')");
		$result6=mysqli_query($con,"SELECT * FROM parinte WHERE intrebare".$a."='f' && ( clasa='".$_POST['clasa_de_vazut']."A' || clasa='".$_POST['clasa_de_vazut']."B' || clasa='".$_POST['clasa_de_vazut']."C'|| clasa='".$_POST['clasa_de_vazut']."D' || clasa='".$_POST['clasa_de_vazut']."E' || clasa='".$_POST['clasa_de_vazut']."F' || clasa='".$_POST['clasa_de_vazut']."G')");
