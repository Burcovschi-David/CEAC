<!doctype html>
<head></head>
<title>LIIS::Parinti Validare::</title>
<html>
 <body bgcolor="#FFFFDA">
  <hr>
  <center>
   ...
   <table border="0" align="center" bgcolor="#FFFFF2">
    <tr>
	 ...
	 session_start();
	   ...
	   if($_SESSION["al41_1"]==" "){
	      echo"<tr><td> 41.1 </td></tr>";
	   }
	   if($_SESSION["al41_2"]==" "){
	      echo"<tr><td> 41.2 </td></tr>";
	   }
	   if($_SESSION["al41_3"]==" "){
	      echo"<tr><td> 41.3 </td></tr>";
	   }
	   if($_SESSION["al41_4"]==" "){
	      echo"<tr><td> 41.4 </td></tr>";
	   }
	   if($_SESSION["al41_5"]==" "){
	      echo"<tr><td> 41.5 </td></tr>";
	   }
	   if($_SESSION["al41_6"]==" "){
	      echo"<tr><td> 41.6 </td></tr>";
	   }
	   if($_SESSION["al42_1"]==" "){
	      echo"<tr><td> 42.1 </td></tr>";
	   }
	   if($_SESSION["al42_2"]==" "){
	      echo"<tr><td> 42.2 </td></tr>";
	   }
	   if($_SESSION["al42_3"]==" "){
	      echo"<tr><td> 42.3 </td></tr>";
	   }
	   if($_SESSION["al43"]==" "){
	      echo"<tr><td> 43 </td></tr>";
	   }
