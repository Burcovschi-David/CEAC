...
while($a!=42){
    ...
    if($a==10 || $a==11 || $a==12 || $a==2 || $a==14 || $a==15 || $a==16 || $a==30 || $a== 37 || $a==28 || $a==39 || $a==40 ){
	    ...
	    if($a==10){
			...
			$result=mysqli_query($con,"SELECT * FROM copii");
	       ...
	       $result2=mysqli_query($con,"SELECT * FROM copii");
	       $nr_a=0;
		    $nr_b=0;
		    $nr_c=0;
		    $nr_d=0;
	       ...
	       $result3=mysqli_query($con,"SELECT * FROM copii");
	       $nr_a=0;
		    $nr_b=0;
		    $nr_c=0;
		    $nr_d=0;
	       ...
	       while($row=mysqli_fetch_assoc($result3)){
	        ...
	        $result4=mysqli_query($con,"SELECT * FROM copii");
	        $nr_a=0;
		    $nr_b=0;
		    $nr_c=0;
		    $nr_d=0;
	       ...
	       $result5=mysqli_query($con,"SELECT * FROM copii");
	       $nr_a=0;
		    $nr_b=0;
		    $nr_c=0;
		    $nr_d=0;
	       ...
	       $result6=mysqli_query($con,"SELECT * FROM copii");
	        $nr_a=0;
		    $nr_b=0;
		    $nr_c=0;
		    $nr_d=0;
	     ...
	     $result1=mysqli_query($con,"SELECT * FROM copii WHERE intrebare".$a."='a'");
		 $result2=mysqli_query($con,"SELECT * FROM copii WHERE intrebare".$a."='b'");		 
		...
		$result1=mysqli_query($con,"SELECT * FROM copii WHERE intrebare".$a."='a'");
		$result2=mysqli_query($con,"SELECT * FROM copii WHERE intrebare".$a."='b'");
		$result3=mysqli_query($con,"SELECT * FROM copii WHERE intrebare".$a."='c'");
		$result4=mysqli_query($con,"SELECt * FROM copii WHERE intrebare".$a."='d'");
		$result5=mysqli_query($con,"SELECT * FROM copii WHERE intrebare".$a."='e'");
		$result6=mysqli_query($con,"SELECT * FROM copii WHERE intrebare".$a."='f'");
